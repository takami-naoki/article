<template>
  <div>
    ...
    <div class="form-group p-5 m-5">
      <h2>Title</h2>
      <input type="text" name="title" class="form-control mb-2" v-model="article.title">
      <h2>Short Description</h2>
      <input type="text" name="short_description" class="form-control mb-2" v-model="article.short_description">
      <h2>Full Description</h2>
      <textarea name="full_description" class="form-control mb-2" v-model="article.full_description"></textarea>
...
export default {
  ...
  methods: {
    ...
    onUpdate: function(id) {
      let url = id == undefined || id == null ? 'http://18.217.62.142/api/articles' : 'http://18.217.62.142/api/articles/' + id;
